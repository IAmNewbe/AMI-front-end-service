...
export default function LargeRoundWidget({ title, value, units }: RoundWidgetProps) {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03] sm:w-full">
      <div className="px-2 pt-2 bg-white shadow-default rounded-2xl pb-5 sm:pb-6 dark:bg-gray-900 sm:px-6 sm:pt-6">
        <div className="flex justify-center text-center">
          <div>
            <h3 className="text-xl text-center justify-center font-semibold text-gray-800 dark:text-white/90">
              {title}
            </h3>
        ...
        <div className="relative ">
          ...
          <span className="absolute left-1/2 top-full -translate-x-1/2 -translate-y-[95%] rounded-full bg-success-50 px-3 py-1 text-xs tsm:text-base md:text-[16px] font-medium text-success-600 dark:bg-success-500/15 dark:text-success-500">
            {units}
          </span>
        </div>
